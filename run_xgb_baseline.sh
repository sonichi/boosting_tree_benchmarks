...
bin/xgboost xgboost.conf tree_method=exact data="data/yahoo.train" eval[test]="data/yahoo.test" objective="rank:ndcg" eval_metric=ndcg@1 eval_metric=ndcg@3 eval_metric=ndcg@5 eval_metric=ndcg@10 max_depth=16 2>&1 | tee xgb_yahoo_accuracy.log
...
bin/xgboost xgboost.conf tree_method=exact data="data/yahoo.train"  objective="rank:ndcg" max_depth=16 2>&1 | tee xgb_yahoo_speed.log
...
bin/xgboost xgboost.conf max_bin=255 tree_method=hist grow_policy=lossguide max_depth=0 max_leaves=255 data="data/yahoo.train" eval[test]="data/yahoo.test" objective="rank:ndcg" eval_metric=ndcg@1 eval_metric=ndcg@3 eval_metric=ndcg@5 eval_metric=ndcg@10 2>&1 | tee xgbhist_yahoo_accuracy.log
...
bin/xgboost xgboost.conf max_bin=255 tree_method=hist grow_policy=lossguide max_depth=0 max_leaves=255 data="data/yahoo.train" objective="rank:ndcg"  2>&1 | tee xgbhist_yahoo_speed.log
