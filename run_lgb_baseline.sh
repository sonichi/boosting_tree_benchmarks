...
bin/lightgbm config=lightgbm.conf data=data/yahoo.train objective=lambdarank 2>&1 | tee lgb_yahoo_speed.log
...
bin/lightgbm config=lightgbm.conf data=data/yahoo.train valid=data/yahoo.test objective=lambdarank metric=ndcg 2>&1 | tee lgb_yahoo_accuracy.log
